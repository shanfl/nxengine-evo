...
void EntityFlagDetailDlg::CheckEdit()
{
	...
	CheckDlgButton(CHECK_FLAG1, flags & 0x0001);
	CheckDlgButton(CHECK_FLAG2, flags & 0x0002);
	CheckDlgButton(CHECK_FLAG3, flags & 0x0004);
	CheckDlgButton(CHECK_FLAG4, flags & 0x0008);
	CheckDlgButton(CHECK_FLAG5, flags & 0x0010);
	CheckDlgButton(CHECK_FLAG6, flags & 0x0020);
	CheckDlgButton(CHECK_FLAG7, flags & 0x0040);
	CheckDlgButton(CHECK_FLAG8, flags & 0x0080);
	CheckDlgButton(CHECK_FLAG9, flags & 0x0100);
	CheckDlgButton(CHECK_FLAG10, flags & 0x0200);
	CheckDlgButton(CHECK_FLAG11, flags & 0x0400);
	CheckDlgButton(CHECK_FLAG12, flags & 0x0800);
	CheckDlgButton(CHECK_FLAG13, flags & 0x1000);
	CheckDlgButton(CHECK_FLAG14, flags & 0x2000);
	CheckDlgButton(CHECK_FLAG15, flags & 0x4000);
	CheckDlgButton(CHECK_FLAG16, flags & 0x8000);
